...
# ─── CONFIG ────────────────────────────────────────────────────
INPUT_FILE  = "annuaire (1).xlsx"          # Fichier source
OUTPUT_FILE = "nnuaire (1)annuaire_resultat.xlsx" # Fichier de sortie
CHECKPOINT  = " (1)checkpoint.xlsx"        # Sauvegarde progressive
HEADLESS    = True                     # False = voir le navigateur
DELAY       = 0.3                     # Délai entre chaque page (secondes)
TIMEOUT     = 5000                    # Timeout par page (ms)
# ─── CONFIG ────────────────────────────────────────────────────
